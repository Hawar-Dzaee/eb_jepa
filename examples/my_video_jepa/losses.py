...
def square_cost_seq(state,predi):
    """Sqaure loss between two [B, C, T, H, W] sequences"""
...
class VCLoss(nn.Module): 
    """Variance-Covariance loss attracting means to zeros and covariance to identity."""
...
class CovarianceLoss(nn.Module):
    def __init__(self):
        """
        Penalizes off-diagonal elements of the covariance matrix to encourage feature decorrelation.
