...
class CosineWithWarmup:
    ...
    def __init__(
        ...
        Args:
            ...
            warmup_ratio (float, optinoal): Fraction of total steps used for linear warmup.
                Defaults to 0.1. 
            min_lr (float, optional): Minimum learning rate reached at the end of cosine 
                annealing. Default to 1e-5
            last_epoch (int, optinal): The index of the last epoch. Default: -1
        """
